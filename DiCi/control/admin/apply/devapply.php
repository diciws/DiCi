...
$stmt = $db->prepare('SELECT devbewerberID, name, ipadress, referenz, warumbewirbst, bewerbung, skills, abschlswort FROM devbewerber WHERE devbewerberID = :devbewerberID');
$stmt->execute(array(':devbewerberID' => $_GET['id']));
$row = $stmt->fetch();

if($row['devbewerberID'] == ''){
	header('Location: ./');
	exit;
}
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
					...
					<div class="row">
						<div class="col-25">
						  ...
						  <div class="col-75">
							<p><?php echo $row['devbewerberID'] ?></p>
						  </div>
					</div>
					<div class="row">
						<div class="col-25">
